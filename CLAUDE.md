# CLAUDE.md
Main guide for Claude — ./GUIDE.md
Code style for project — ./CODE_STYLE.md
...
## Напоминание
- Перед каждым изменением файла — проверь CODE_STYLE.md
- Перед архитектурными решениями — проверь GUIDE.md
...
- При обновлении CHANGELOG.md — новые записи всегда добавляй **сверху**, сразу после шапки (от новых к старым)