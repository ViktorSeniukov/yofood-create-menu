...
Извлекай данные ТОЛЬКО для этих пяти дней. Субботу и воскресенье игнорируй.
...
- "Glavno jelo" → "Горячее"
- "Prilozi" → "Гарнир"
- "Obrok salate" → "Гарнир" (ВАЖНО! Обеденные салаты — это полноценные блюда, они идут в категорию "Гарнир", а НЕ в "Салат")
- "Salat bar" → "Салат"
- "Desert" → "Десерт"

ВАЖНО ПРО ОБЕДЕННЫЕ САЛАТЫ (Obrok salate):
Раздел «Obrok salate» содержит сытные салаты, которые являются полноценным блюдом (аналог второго блюда). Их нужно помещать в категорию «Гарнир», объединяя с блюдами из раздела «Prilozi». Раздел «Salat bar» — это обычные лёгкие салаты и закуски, их помещай в категорию «Салат».
...
- Если в оригинале есть текст на кириллице (например, названия супов на русском/сербской кириллице) — переведи смысл на русский, а в сербской части после "/" запиши транслитерацию латиницей.
...
Пример формата:
{
  "Понедельник": {
    ...
    "Гарнир": [
      "Салат с креветками (микс хрустящих салатов, огурец, креветки, черри, кукуруза, киноа) / Salata sa gamborima (miks hrskavih salata, krastavac, gambori, cherry paradajz, kukuruz šećerac, kinoa)",
      "Цезарь салат (куриное филе, микс зелёных салатов, гренки, бекон, майонез, черри, пармезан) / Cezar salata (pileći file, miks zelenih salata, krutoni, slanina, majonez, cherry paradajz, parmezan)",
      "Картофельное пюре / Krompir pire"
    ],
    "Салат": ["Салат из капусты / Kupus salata"],
